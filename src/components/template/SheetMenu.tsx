...
export const SheetMenu = ({open, setOpen}:{open:boolean,setOpen:any}) => {

  const [position, setPosition] = useState(0)

  // const [open, setOpen] = useState(sheetStatus)
...
function InnerSheet(props: SheetProps) {
  ...
  return (
    ...
    <Sheet animation="bouncy" modal snapPoints={[90]} dismissOnSnapToBottom {...props}>
